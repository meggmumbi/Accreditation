<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Login.aspx.cs" Inherits="kasnebAccreditation.Login" %>
<!DOCTYPE html>
...
<body>
    ...
    <div class="bg-img">
        <div class="content">
            ...
            <div class="signup">
                Don't have account?
          <a href="RequestAccountCreation.aspx">Signup Now</a>
            </div>
        </div>
    </div>
