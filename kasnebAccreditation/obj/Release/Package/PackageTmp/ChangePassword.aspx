<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ChangePassword.aspx.cs" Inherits="kasnebAccreditation.ChangePassword" %>

<!DOCTYPE html>
<html>
<head>
    <img src="images/kasneb-logo.png" />
    <meta charset="utf-8">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            <label class="control-label">Enter Registered Email Address: <span class="text-danger">*</span></label>
                                            <input type="text" class="form-control" id="txtemailaddress" >
                                        </div>
                                    </div>
                                    <div class="col-sm-6">
                                        <div class="form-group pass_show">
                                            <label class="control-label">Enter Old Password: <span class="text-danger">*</span></label>
                                            <input class="form-control" type="password" id="txtoldpassword">
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
