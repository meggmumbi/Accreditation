<%@ Page Title="" Language="C#" MasterPageFile="~/test.Master" AutoEventWireup="true" CodeBehind="detailedReport.aspx.cs" Inherits="kasnebAccreditation.detailedReport" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="panel panel-primary">
            ...
            <div class="panel-heading"> <i class="icon-file"></i>
              Self Evaluation Detailed Report
            </div>
            <!-- /widget-header -->
