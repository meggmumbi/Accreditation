...
{
    public partial class selfEvaluationScore : System.Web.UI.Page
    {
            ...
            if (!IsPostBack)
            {
                ...
                if (!Error)
                {
                    try
                    {
                        ...
                        //string applicationNo = score.Text.Trim();
                        String status = new Config().ObjNav().PrintScore(applicationNo);
