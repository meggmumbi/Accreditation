...
{
    public partial class summeryScore : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                score.Text = Request.QueryString["code"];
                ...
                if (!Error)
                {
                    try
                    {
                        ...
                        String status = new Config().ObjNav().Printdsummeryscore(applicationNo);
